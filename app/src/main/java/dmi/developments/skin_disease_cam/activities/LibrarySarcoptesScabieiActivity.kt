...
class LibrarySarcoptesScabieiActivity : BottomNavActivity() {

    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.library_sarcoptes_scabiei)
        ...
        val remedyTextView = findViewById<TextView>(R.id.scabies_home_remedy)
        remedyTextView.text = HtmlCompat.fromHtml(
            getString(R.string.scabies_home_remedy),
