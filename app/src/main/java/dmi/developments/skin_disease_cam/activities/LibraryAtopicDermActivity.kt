...
class LibraryAtopicDermActivity : BottomNavActivity() {

    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.library_atopic_derm)
        ...
        val remedyTextView = findViewById<TextView>(R.id.ad_home_remedy)
        remedyTextView.text = HtmlCompat.fromHtml(
            getString(R.string.ad_home_remedy),
