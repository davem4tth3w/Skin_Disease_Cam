...
class LibraryImpetigoActivity : BottomNavActivity() {

    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.library_impetigo)
        ...
        val remedyTextView = findViewById<TextView>(R.id.imp_home_remedy)
        remedyTextView.text = HtmlCompat.fromHtml(
            getString(R.string.imp_home_remedy),
