...
class LibraryTineaInfectionActivity : BottomNavActivity() {

    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.library_tinea_infection)
        ...
        val remedyTextView = findViewById<TextView>(R.id.tinea_home_remedy)
        remedyTextView.text = HtmlCompat.fromHtml(
            getString(R.string.tinea_home_remedy),
